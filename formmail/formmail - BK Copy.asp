...
<%	'==========================================================================
	...
	function SendMail()
		...
		if mailComp = "CDOSYS" then
			...
			cdoMessage.HtmlBody = "Hi,<br/>Thank you for your interest in Netpace, the leader in Cloud Computing and Training.<br/>So this is to let you know, we have received your message and we'll respond back short. <br/>Sincerely,<br/>Netpace Staff"
			on error resume next
			cdoMessage.Send
			if Err.Number <> 0 then
				SendMail = "Email send failed: " & Err.Description & "."
